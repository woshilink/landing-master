			...
			<div class="col-xs-4 hidden-xs left-box">
				<div class="offer">
					<a href="{$url}" rel="nofollow">
						...
						<!--<img src="../template/templates/casino/{$lp}/{$lang}/button.png" class="btn img-responsive center-block" alt="">-->
					</a>
				</div>
				<!-- end of offer -->
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<a href="{$url}" rel="nofollow">
						...
						<img src="../template/templates/casino/{$lp}/{$lang}/steps_mobile.jpg" alt="" class="visible-xs img-responsive center-block">
					</a>
				</div>
			</div>
