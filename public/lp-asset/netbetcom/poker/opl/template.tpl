...
{config_load file=$lpconf}
  ...
  <section id="steps">
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12">
          <img src="../template/templates/poker/opl/{$lang}/steps.png" alt="STEPS" class="center-block img-responsive hidden-xs" />
          <img src="../template/templates/poker/opl/{$lang}/steps_mobile.png" alt="STEPS" class="center-block img-responsive visible-xs" />
        </div>
...
<script src="landing/viva/src/js/remodal.min.js" async></script>
 ...
 <script>
     $(function(){
        $("#modal1Desc").load("../template/templates/poker/opl/{$lang}/terms.html");
      });
