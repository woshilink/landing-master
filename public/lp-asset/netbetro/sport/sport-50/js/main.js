...
jQuery(document).ready(function($){
    ...
    $('.floating-background, .floating-text').find('img').eq(0).load(function() {
    ...
    $(window).on('resize', function(){
        if( $('html').hasClass('preserve-3d') ) {
            ...
            $('.floating-background, .floating-text').attr('style', '').removeClass('is-absolute');
        }
    });
    ...
    function initBackground() {
        ...
        $('.floating-background, .floating-text').addClass('is-absolute').css({
            'left' : newLeft,
            'top' : newTop,
            'width' : newImageWidth,
        });
    ...
    function moveBackground(event, topOffset) {
        ...
        $('.floating-background, .floating-text').css({
