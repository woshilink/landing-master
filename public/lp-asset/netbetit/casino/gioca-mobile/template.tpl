    ...
    <div class="container-fluid wrapper">
      <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 ">
              <div class="slot">
                <img src="../template/templates/casino/{$lp}/pic.png" alt="Slot" class="img-responsive center-block "/>
              </div>
          </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <img src="../template/templates/casino/{$lp}/mobile.jpg" alt="OFFER" class="img-responsive center-block"/>
