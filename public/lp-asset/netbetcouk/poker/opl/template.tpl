...
<link href="../template/templates/poker/opl/style.css" rel="stylesheet">
...
<link rel="stylesheet" href="landing/viva/src/css/remodal-default-theme.css">
 ...
 <style media="screen">
    #main{
      background-image: url('../template/templates/poker/opl/bg.jpg');
...
{config_load file=$lpconf}
  ...
  <section id="mobile" class="visible-xs">
    <img src="../template/templates/poker/opl/bg-mobile.jpg" alt="PLAY POKER" class="img-responsive" />
  </section>
  <section id="main">
  ...
  <section id="steps">
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12">
          <img src="../template/templates/poker/opl/steps.png" alt="STEPS" class="center-block img-responsive hidden-xs" />
          <img src="../template/templates/poker/opl/steps_mobile.png" alt="STEPS" class="center-block img-responsive visible-xs" />
        </div>
...
<script src="landing/viva/src/js/remodal.min.js" async></script>
 ...
 <script>
     $(function(){
        $("#modal1Desc").load("../template/templates/poker/opl/terms.html");
      });
