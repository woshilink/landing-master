...
<html lang="en">
  <head>
    ...
    <link href="betfirst/src/css/styles.css" rel="stylesheet">
   ...
   <h1>hahah</h1>
    ...
    <section class="mobile visible-xs">
    	<div class="container">
    		<div class="row">
    			<div class="col-xs-12">
    					<img src="betfirst/{$lang}/mobile.jpg" class="img-responsive  " alt="">
    				<div class="button" >
              	 		<img src="{$lang}/img/button.png" class="img-responsive center-block" alt="">
            		</div>
    			</div>
    		</div>
    	</div>
    ...
    <section class="main hidden-xs">
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-10 col-sm-9 col-lg-9  pull-right">
            ...
            <div class="button" >
              	 <img src="{$lang}/img/button.png" class="img-responsive col-sm-offset-6 col-xs-offset-4" alt="">
	      		<!-- <h1>GET A &pound;50 FREE BET</h1> -->
        ...
        <!-- <div class="row">
		 ...
		 <div class="row">
          	<div class="col-xs-12 hidden-xs steps">
              	<img src="template/templates/sport/{$lp}/{$lang}/steps.png" alt="" class="img-responsive center-block">
          	</div>
     	</div>
        </div>
        <!-- end of button row -->
