                            ...
                            <div class="col-xs-6 ">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination pull-right">
                                        <li>
                                            <h4>
                                                <span class="label label-primary">Total {{ landingapprovelist.length }} Pages</span>
                                            </h4>
                                        </li>
                                    </ul>
                                </nav>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12 ">
                                        <div class="count"> {{ landingapprovelist.length }}</div>
                                        <h4>Live Landing Pages</h4>
                                        <div class="row">
                                            <div class="col-sm-6 "><h4 class="text-center text-primary">{{ landingapprovelist.length }}</h4></div>
                                            <div class="col-sm-6 "><h4 class="text-center text-primary">Templates</h4></div>
                                        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/api/templates/approvedlist').then(response => this.approvedlist = response.data);
