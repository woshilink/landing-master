...
{block name=body}
        ...
        <div class="my-content">
            <div class="main-cta-wrapper">
                <div class="main-cta">
                    <div class="justify">
                        <h1 class="text-1"></h1>
                        <h2 class="text-3" style="font-size: 2em;">DUBLEAZĂ-ŢI PRIMUL DEPOZIT<br>PÂNĂ LA 800RON</h2>
                        <h3 class="text-4" style="font-size: 5em;">55 RUNDE GRATUITE</h3>
                        <h2 class="text-3" style="font-size: 2em;">Doar pentru jucatorii inregistrati<br>pe UNDEPARIEM</h2>
                        <a href="{$cta.casino}" class="button yellow">APASĂ AICI</a>
                    </div>
    ...
    <div class="remodal" data-remodal-id="modal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
        ...
        <div>
            {include file="pages/landing/{$domain}/terms/{$product}/800ron+55/terms.tpl"}
        </div>
