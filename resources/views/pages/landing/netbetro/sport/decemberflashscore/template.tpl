...
{block name=body}
    ...
    <section class="main">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 hidden-sm hidden-xs pull-right">
            <div style="margin-bottom: 60%; margin-top: 5%">
                <img src="{$asset}/img/gift.png" alt="" class="img-responsive center-block">
            </div>
             <!-- end of button row -->
          </div>
        </div>
