                    ...
                    <div class="casino-offer">
                        ...
                        <div class="icon" >
                            <a href="{$cta.casino}" rel="nofollow">
                                <img src="{$asset}/img//casino-offer-d.png" class="img-responsive center-block hidden-xs" alt="">
                                <img src="{$asset}/img//casino-offer-m.png" class="img-responsive center-block visible-xs" alt="">
                                <img src="{$asset}/img//casino-offer-d.png" class="img-responsive center-block visible-xxs" alt="">
                            </a>
                        </div>
                    ...
                    <div class="box">
                        <div class="sport-offer" >
                            <a href="{$cta.sport}" rel="nofollow">
                                <img src="{$asset}/img//sport-offer-d.png" class="img-responsive center-block hidden-xs" alt="">
                                <img src="{$asset}/img//sport-offer-m.png" class="img-responsive center-block visible-xs" alt="">
                                <img src="{$asset}/img//sport-offer-d.png" class="img-responsive center-block visible-xxs" alt="">
                            </a>
                        </div>
                        <!-- end of offer row -->
                ...
                <div class="col-xs-12">
                    <div class="term">
                        <a href="#modal" rel="nofollow">
                            <div class="text-left">* Termeni și Condiții</div>
                        </a>
                    </div>
                </div>
            </div>
