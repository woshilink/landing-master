            ...
            <div class="container-fluid hidden-xs">
                <div class="row" style="margin-top:1em; margin-bottom:1em;">
                    <a href="{$cta.sport}" rel="nofollow">
                        ...
                        {else}
                            <div class="col-xs-12 col-sm-4">
                                <img src="sport_fr/src/img/step1.png" alt="Vivez les émotions du direct en pariant jusqu'à la dernière minute !" class="img-fill center-block" style="max-width:312px;">
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <img src="sport_fr/src/img/step2.png" alt="Ne manquez plus jamais un match !" class="img-fill center-block" style="max-width:312px;">
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <img src="sport_fr/src/img/step3.png" alt="Profitez des conseils d'un pro du football !" class="img-fill center-block" style="max-width:312px;">
                            </div>
                        {/if}
                    </a>
                </div>
