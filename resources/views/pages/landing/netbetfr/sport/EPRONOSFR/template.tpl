...
{block name=body}
    {include file="lab/atoms/text/netbetfr/licence-text.tpl"}
    <section id="main-nav">
      ...
      <div class="row visible-xs">
        <div class="col-xs-12">
          ...
          <a href="{$cta.sport}" class="button1">
            <img src="{$asset}/img/button.png" alt="Rejoignez-nous!" class="img-fill" >
            </a>
          </div>
        </div>
           <!-- end of button row -->
...
{block name="footer"}
    ...
    <script>
        ...
        $(".promo img").attr('src', '{$asset}/img/responsive-logo.png');
