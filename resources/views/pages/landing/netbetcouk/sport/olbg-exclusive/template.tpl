...
{block name=body}
    <section id="main-nav">
        <nav class="navbar black-transparent navbar-fixed-top">
            <div class="container">
                {include file="lab/organisms/nav/nav-main.tpl" text='New Customer Welcome Offer' link=$cta.sport}
            </div>
        </nav>
    </section>
    <a href="{$cta.sport}">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 pull-right">
                    ...
                    <div class="main-cta">
                        <div class="justify text-uppercase">
                            <h2 class="text-2 text-white" style="font-size: 5em;"><img src="{$asset}/img/olbg.png" alt="olbg"> EXCLUSIVE</h2>
                            ...
                            <div class="col-xs-6">
                                <div class="panel text-center">
                                        <div class="reg-button-wrapper">
                                            ...
                                            <span class="reg-text-3 text-green">£50</span>
                            ...
                            <div class="col-xs-6">
                                <div class="panel text-center">
                                    <div class="log-button-wrapper">
                                        <span class="reg-text-4 text-yellow">£250</span>
                                        <span class="reg-text-1 text-white">FREE BETS</span>
                                        <span class="reg-text-1 text-white">GIVEAWAY*</span>
                                        <span class="reg-text-1 text-white">EVERY MONTH</span>
                        ...
                        <span class="terms-wrap text-white text-center">
                            	<span class="terms-wrap">
                            	    18+ | £50 free bet rollover is x6 | Free Bet is 50% matched to deposit | T&amp;Cs apply
                                </span>
                        	</span>
                    </div>
            ...
            <div class="row ">
              <div class="col-xs-12">
                  <div class="free-bet-offer">
                      ...
                      <button data-promocode="WELCOME50" data-cta-action="same" href="{$cta.casino}" class="btn-primary button loaded-y register-cta">BET NOW</button>
                  </div>
              </div>
            </div>
        </div>
