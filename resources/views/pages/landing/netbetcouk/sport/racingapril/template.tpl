                ...
                <div class="col-xs-12 col-sm-12 col-md-5 pull-right">
                    <div class="main-cta">
                        <div class="justify text-uppercase">
                            ...
                            <h2 class="text-green text2" >{#text2#}</h2>
                        ...
                        <span class="terms-wrap text-white">
                            	New Customers Only<br>Enter Code WELCOME50<br>Playthrough is x6 (Deposit &amp; Bonus)<br><span class="terms-click"><u>T&amp;C's Apply*</u></span>
                        	</span>
                    </div>
