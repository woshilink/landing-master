...
{block name=head}
  ...
  <style media="screen">
    ...
    .bottom-blocks .row .wrapper .button-wrapper {
      position: relative;
      right: -6.5em;
      bottom: -1em;
      /* padding: 10px; */
          ...
          <div class="wrapper light-color">
            ...
            <div>
              <div>
                ...
                <div class="button-wrapper">
                  <a data-promocode="NETBET" data-cta-action="same" href="{$cta.casino}" class="btn-primary button loaded-y register-cta"><img src="//go.livepartners.com/ads.netbet.co.uk_devnathi/casino/tv-lander/src/img/right-arrow.png" height="18" width="18">&nbsp;&nbsp;REGISTER NOW</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="wrapper light-color">
                    <div>
                      <div>
                        ...
                        <div class="button-wrapper">
                          <a data-promocode="NETBET" data-cta-action="same" href="{$cta.casino}" class="btn-primary button loaded-y register-cta"><img src="//go.livepartners.com/ads.netbet.co.uk_devnathi/casino/tv-lander/src/img/right-arrow.png" height="18" width="18" style="">&nbsp;&nbsp;REGISTER NOW</a>
                        </div>
    ...
    <div class="container">
      <div class="row ">
        <div class="col-md-11 ">
          ...
          <p class=" terms">
            *<a href="#modal">
              <span class="color-white">Terms &amp; Conditions</span>
...
{block name="footer"}
  ...
  <script type="text/javascript">
    $(function(){
      $("#modal1Desc").load("{$asset}/vip-terms.html");
    });
