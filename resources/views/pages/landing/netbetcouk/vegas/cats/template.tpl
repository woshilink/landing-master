...
{block name=body}
    ...
    <a href="{$cta.vegas}"><section class="main">
                ...
                <div class="steps">
                    <div class="container-fluid">
                        <div class="row text-center">
                            <span style="color: #ffffff; text-shadow: 1px 1px #000;">New Players only, no deposit required, wagering &amp; <a href="https://vegas.netbet.co.uk/freespins_gb" rel="nofollow" target="_blank" style="color: white; text-decoration: underline">T&amp;C's</a> Apply</span>
                        </div>
                    </div>
                    <div class="container-fluid">
    ...
    <section class="tc">
        <div class="container-fluid">
            <div class="row">
                <div  class="col-xs-12">
                    <a href="https://vegas.netbet.co.uk/signupspins_gb">
...
{block name=footer}
    ...
    <script>
        $(function(){
            ...
            $("#modal1Desc").load("landing/cats/terms.html");
        });
    </script>
