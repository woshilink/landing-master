                ...
                <div class="col-xs-7 col-sm-5 pull-right">
                    <a href="{$url}" rel="nofollow">
                        <div class="offer" >
                            ...
                            {else}
                                <img src="l{$asset}/offer.png" class="img-responsive pull-right" />
                            {/if}
                        </div>
                    </a>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        {else}
                            <img src="l{$asset}/mobile.jpg" class="img-responsive center-block" />
                            <img src="l{$asset}/offer-mobile.png" class="img-responsive center-block" />
                        {/if}
            ...
            <div class="container-fluid">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-xs-12 hidden-xs">
                                    ...
                                    {else}
                                        <img src="l{$asset}/steps.png" alt="" class="img-responsive center-block">
                                    {/if}
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 visible-xs">
                        ...
                        {else}
                            <img src="l{$asset}/steps_mobile.png" alt="" class="img-responsive center-block">
                        {/if}
                    </div>
                </div>
