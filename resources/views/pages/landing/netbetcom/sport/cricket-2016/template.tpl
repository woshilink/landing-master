                    ...
                    <div class="main-cta">
                        ...
                        <div class="justify">
                            ...
                            {elseif $lang == 'ie'}
                                ...
                                <h3 class="text-4 text-white">BONUS</h3>
                                <h3 class="text-5"></h3>
                            {elseif $lang == 'ru'}
                                <h1 class="text-1"></h1>
                            ...
                            {else}
                                <h1 class="text-1"></h1>
                                <h2 class="text-2 text-white" style="font-size: 4.6em;">Get a</h2>
                                <h2 class="text-3 text-green" style="font-size: 8.5em; margin-top: 0;line-height: 0.9;">&euro;/&dollar;50</h2>
                                <h3 class="text-4 text-white" style="font-size: 7.6em;margin-top: 0;">BONUS</h3>
                                <h3 class="text-5"></h3>
                            {/if}
                        </div>
                        </a>
