                ...
                <div class=" col-xs-12">
                    <div class="main-cta">
                        ...
                        <div class="justify">
                            {if $lang == 'nl'}
                                <h1 class="text-1"></h1>
                                <h2 class="text-3 text-green" style="font-size: 12.7em;margin-bottom: 0;">&euro;50</h2>
                                <h2 class="text-2 text-white" style="font-size: 6.7em; margin-top: 0;">Gratis</h2>
                                <h3 class="text-4 text-white" style="font-size: 5.7em;">Inzet</h3>
                                <h3 class="text-5"></h3>
                            {elseif $lang == 'ie'}
                                <h1 class="text-1"></h1>
                                <h2 class="text-2 text-white">Get a</h2>
                                <h2 class="text-3 text-green">&euro;50</h2>
                                <h3 class="text-4 text-white">Free Bet</h3>
                                <h3 class="text-5"></h3>
                            {elseif $lang == 'ru'}
                                <h1 class="text-1"></h1>
                            ...
                            {elseif $lang == 'fr'}
                                <h1 class="text-1"></h1>
                                <h2 class="text-3 text-green" STYLE="font-size: 14em;">50&euro;</h2>
                                <h2 class="text-2 text-white" style="font-size: 5.6em;">Gratuits</h2>
                                <h3 class="text-4"></h3>
                                <h3 class="text-5"></h3>
                            {elseif $lang == 'gb'}
                                <h1 class="text-1"></h1>
                            ...
                            {elseif $lang == 'de'}
                                <h1 class="text-1"></h1>
                                <h2 class="text-2"></h2>
                                <h2 class="text-3 text-green" style="font-size: 12em;">100%</h2>
                                <h3 class="text-4 text-white" style="font-size: 3.1em;">Einzahlungsbonus</h3>
                                <h3 class="text-5"></h3>
                            {elseif $lang == 'gr'}
                                <h1 class="text-1"></h1>
                                <h2 class="text-2"></h2>
                            ...
                            {else}
                                <h1 class="text-1"></h1>
                                <h2 class="text-2 text-white" style="font-size: 6.6em;">Get a</h2>
                                <h2 class="text-3 text-green" style="font-size: 12em; margin-top: 0;line-height: 0.9;">&dollar;50</h2>
                                <h3 class="text-4 text-white" style="font-size: 5.6em;margin-top: 0;">Free Bet</h3>
                                <h3 class="text-5"></h3>
                            {/if}
                        </div>
            ...
            <div class="row hidden ">
                <div class="terms-text">
                    <div class="col-xs-12" style=" font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif">
                        {if $lang == 'nl'}
                            {include file="pages/landing/{$domain}/terms/sport/welcome-offer/{$lang}/netbet100.tpl"}
                        {else}
