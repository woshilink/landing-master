           ...
           <div class="row ">
               <div class="col-xs-12">
                   <div class="free-bet-offer">
                       ...
                       <a data-promocode="WELCOME50" data-cta-action="same" href="{$cta.sport}" class="btn-primary button loaded-y banner-cta pull-right" style="text-decoration: none">{#b_button#}</a>
            ...
            <div class="row hidden ">
                <div class="terms-text">
                   <div class="col-xs-12" style=" font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif">
                       {include file="pages/landing/netbetcom/terms/sport/welcome-offer/{$lang}/terms.tpl"}
                   </div>
                </div>
