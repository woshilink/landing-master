            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12 hidden-xs">
                        {if $lang == 'ie'}
                            <img src="en/img/steps.png" alt="" class="img-responsive center-block">
                        {elseif $lp == '50plus10'}
                ...
                <div class="row">
                    <div class="col-xs-12 visible-xs">
                        {if $lang == 'ie'}
                            <img src="en/img/steps_mobile.png" alt="" class="img-responsive center-block">
                        {elseif $lp == '50plus10'}
...
{block name=footer}
    ...
    <script>
        $(function(){
            {if $lang == 'ie'}
            $("#modal1Desc").load("terms/en/black-friday-terms.html");
            {elseif $lp == '50plus10'}
            $("#modal1Desc").load("terms/{$lang}/get50free-plus10-2.html");
            {elseif $lp == 'wetttipps-heute'}
            $("#modal1Desc").load("{$lang}/terms.html");
            {else}
            $("#modal1Desc").load("terms/{$lang}/black-friday-terms.html");
            {/if}
        });
    </script>
