...
{block name=head}
    ...
    <style>
        ...
        {if $lang == 'nl'}
            .main-cta-wrapper .main-cta .text-2 {
                font-size: 4.5em;
            }
        {/if}
    </style>

    {if $smarty.get.id == '299423' }
        <script type="text/javascript">
            document.location='{url('/')}/{$product}?{$url_input|replace:'id=299423':'id=307920'|replace:'&lp=200double-offer':''}';
        </script>
    {/if}
{/block}
{block name=body}
    ...
    <div class="my-content">
        <div class="main-cta-wrapper">
            <div class="main-cta">
                <div class="justify">
                    <h1 class="text-1"></h1>
                    <h2 class="text-2">{#offer1#}</h2>
                    <h2 class="text-3">{#offer2#}</h2>
                    <h3 class="text-4">{#price#}</h3>
                    <a href="{$cta.casino}" class="button yellow">{#cta#}</a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="step">
                            ...
                            <div class="text">
                                <h4 class="heading" style="letter-spacing: 0; font-family: 'MS PGothic', sans-serif;">{#step1#}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="step">
                            ...
                            <div class="text">
                                <h4 class="heading" style="letter-spacing: 0; font-family: 'MS PGothic', sans-serif;">{#step2#}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="step">
                            ...
                            <div class="text">
                                <h4 class="heading" style="letter-spacing: 0; font-family: 'MS PGothic', sans-serif;">{#step3#}</h4>
                            </div>
                        </div>
                    </div>
                </div>
