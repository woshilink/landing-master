                    ...
                    <div class="casino-offer">
                        ...
                        <div class="icon" >
                            <a href="{$cta.casino}" rel="nofollow">
                                {* <img src="{$asset}/img/casino_desk.png" class="img-responsive center-block hidden-xs" alt=""> *}
                                <img src="{$asset}/img/casino_mobile.png" class="img-responsive center-block hidden-xxs" alt="">
                                <img src="{$asset}/img/casino_desk.png" class="img-responsive center-block visible-xxs" alt="">
                            </a>
                        </div>
                    ...
                    <div class="box">
                        <div class="sport-offer" >
                            <a href="{$cta.sport}" rel="nofollow">
                                {* <img src="{$asset}/img/sport_desk.png" class="img-responsive center-block hidden-xs" alt=""> *}
                                <img src="{$asset}/img/sport_mobile.png" class="img-responsive center-block hidden-xxs" alt="">
                                <img src="{$asset}/img/sport_desk.png" class="img-responsive center-block visible-xxs" alt="">
                            </a>
                        </div>
                        <!-- end of offer row -->
                    </div>
