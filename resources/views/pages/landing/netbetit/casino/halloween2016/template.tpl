...
{block name=head}
    <!-- Bootstrap -->
    <link href="halloween/src/css/bootstrap.min.css" rel="stylesheet">
    <link href="footer.css" rel="stylesheet">
    <link href="../template/templates/casino/{$lp}/style.css" rel="stylesheet">
    <link rel="stylesheet" href="affiliate/src/css/remodal.css">
    <link rel="stylesheet" href="affiliate/src/css/remodal-default-theme.css">
...
{block name=body}
    ...
    <script src="affiliate/src/js/remodal.min.js"></script>
